...
BASE_DEST = r'C:\local_data\futures\solusdt2'
CHUNK_SIZE_JSON = 3_000_000      # tune based on memory
CHUNK_SIZE_NPY  = 3_000_000    # rows per chunk for .npy
...
def convert_json_to_npz(path: str):
    ...
    out_path = os.path.join(BASE_DEST, p.stem + ".npz")
...
if __name__ == "__main__":
    ...
    records = glob.glob(r'\\desktop-ditjgjb\E\data\futures\solusdt\*')
    print(len(records))
